...
-- ('90', 'Executive', '100', '1700'),('100', 'Finance', '108', '1700'),
-- ('110', 'Accounting', '205', '1700'),('120', 'Treasury', '0', '1700'),
-- ('130', 'Corporate Tax', '0', '1700'),('140', 'Control And Credit', '0', '1700'),
-- ('150', 'Shareholder Services', '0', '1700'),('160', 'Benefits', '0', '1700'),
-- ('170', 'Manufacturing', '0', '1700'),('180', 'Construction', '0', '1700'),
-- ('190', 'Contracting', '0', '1700'),('200', 'Operations', '0', '1700'),
-- ('210', 'IT Support', '0', '1700'),('220', 'NOC', '0', '1700'),
-- ('230', 'IT Helpdesk', '0', '1700'),('240', 'Government Sales', '0', '1700'),
-- ('250', 'Retail Sales', '0', '1700'),('260', 'Recruiting', '0', '1700'),
-- ('270', 'Payroll', '0', '1700');
...
-- select first_name,email from employees e,departments d where e.DEPARTMENT_ID=d.DEPARTMENT_ID and DEPARTMENT_NAME='executive';
